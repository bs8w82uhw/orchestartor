...
class Monitoring {
	...
	handleMonitoringData(socket, params) {
		...
		// only mark minute as processed after server groups are valid
	...
	handleQuickMonData(socket, data) {
		...
		// defensive guard: quick monitor payload can arrive before server group data is fully populated
