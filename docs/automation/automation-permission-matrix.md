...
- baseUrl: `https://127.0.0.1:5523`
- summary: **ok 31 / fail 0**
- scope: roles, buckets (including ops-agent-reports/prompts), groups, tags, channels, webhook, daily healthcheck + incident/change + ticket scheduler + inventory check + agent role events
